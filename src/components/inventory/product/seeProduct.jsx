                          ...
                          <div className="product-qnty">
                            ...
                            <fieldset>
                              <InputGroup className="bootstrap-touchspin">
                                ...
                                <InputGroupText className="ms-0">
                                  <Button color="primary btn-square" className="bootstrap-touchspin-up" onClick={plusQty}><i className="fa fa-plus"></i></Button>
                                </InputGroupText>
                              </InputGroup>
                            </fieldset>
                            <div className="addcart-btn">
                              {/* <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/cart/${layout}`}><Button color="primary" className="me-2 mt-2" onClick={() => addcart(singleProduct, quantity)}>{AddToCart}</Button></Link> */}
                              <Button onClick={() => onClickDetailPage(singleProduct)} color="primary" className="me-2 mt-2">{ViewDetails}</Button>
                            </div>
                          </div>
                        </Col>
                      </div>
